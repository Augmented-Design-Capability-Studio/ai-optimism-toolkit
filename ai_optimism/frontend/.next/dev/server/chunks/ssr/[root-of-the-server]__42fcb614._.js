...
const aiApi = {
    ...
    validateConnection: async (request)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/ai/validate-connection/`, request);
        return response.data;
    },
    // Get list of available providers and their models
    listProviders: async ()=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`${API_URL}/ai/providers/`);
        return response.data;
    },
    // Generate variable suggestions using AI
    generateVariables: async (request)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/ai/generate-variables/`, request);
        return response.data;
    },
    // Generate computed properties based on variables
    generateProperties: async (request)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/ai/generate-properties/`, request);
        return response.data;
    },
    // Generate objective function code from description
    generateObjective: async (request)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/ai/generate-objective/`, request);
        return response.data;
    },
    // Generate constraint expressions
    generateConstraints: async (request)=>{
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post(`${API_URL}/ai/generate-constraints/`, request);
        return response.data;
    }
};
...
const AIProviderProvider = ({ children })=>{
    ...
    const connect = async (provider, apiKey, model, endpoint)=>{
        ...
        try {
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$ai$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].validateConnection({
                provider,
                api_key: apiKey,
                model,
                endpoint
...
//# sourceMappingURL=%5Broot-of-the-server%5D__42fcb614._.js.map