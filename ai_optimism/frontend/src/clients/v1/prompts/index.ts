...
/**
 * System prompt for v1 chat assistant
 */
export const CHAT_SYSTEM_PROMPT_V1 = `You are an expert optimization assistant helping users design optimization problems.
...
/**
 * Prompt for problem formalization (v1 default)
 */
export const getFormalizationPromptV1 = (
...
/**
 * Prompt for generating a specific formalization component (v1 default)
 */
export const getComponentGenerationPromptV1 = (
...
- If specific limit values aren't mentioned, use reasonable threshold values based on the problem context (these are starting points)`;
  ...
  const componentLabel = component.charAt(0).toUpperCase() + component.slice(1);
