...
/**
 * System prompt for v3 chat assistant
 */
export const CHAT_SYSTEM_PROMPT_V3 = `You are an expert optimization assistant helping users design optimization problems.
...
/**
 * Prompt for problem formalization (v3 default)
 */
export const getFormalizationPromptV3 = (
...
/**
 * Prompt for generating a specific formalization component (v3 default)
 */
export const getComponentGenerationPromptV3 = (
